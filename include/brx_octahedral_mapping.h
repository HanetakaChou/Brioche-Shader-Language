...
static inline DirectX::XMFLOAT2 brx_octahedral_map(DirectX::XMFLOAT3 const &position_sphere_surface)
{
    ...
    float const manhattan_norm = DirectX::XMVectorGetX(DirectX::XMVector3Dot(DirectX::XMVectorAbs(DirectX::XMLoadFloat3(&position_sphere_surface)), DirectX::XMVectorSplatOne()));
